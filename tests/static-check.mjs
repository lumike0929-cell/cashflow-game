...
assert.match(await readFile("funSystem.js", "utf8"), /strategyEventDefinitions/);
assert.match(await readFile("localMultiplayerSystem.js", "utf8"), /normalizeLocalSetup/);
...
assert.match(await readFile("releaseInfo.js", "utf8"), /1\.24\.3-startflow-p0/);
...
assert.match(await readFile("sw.js", "utf8"), /cashflow-game-shell-startflow-p0-20260731/);
